...
CREATE INDEX idx_user_roles_assigned_by ON user_roles(assigned_by_admin_id);

CREATE INDEX idx_volunteer_ratings_volunteer_id ON volunteer_ratings(volunteer_id);
CREATE INDEX idx_volunteer_ratings_rated_by ON volunteer_ratings(rated_by_user_id);
CREATE INDEX idx_volunteer_ratings_project_id ON volunteer_ratings(project_id);
CREATE INDEX idx_volunteer_ratings_skill_claim_id ON volunteer_ratings(skill_claim_id);
...
CREATE INDEX idx_project_team_members_volunteer_id ON project_team_members(volunteer_id);
